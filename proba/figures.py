...
# Domain-neutral drawing machinery: stdlib only, no corpus vocabulary. The OKLab heat ramp
# is contrast-checked at every step and colour-blind safe — reimplementing it worse would
# serve nobody. The prose and the vocabulary around these figures are ours; see report.py.
